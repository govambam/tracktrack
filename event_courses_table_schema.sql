-- Create event_courses table with all required columns
-- Run this in your Supabase SQL Editor

-- Create event_courses table if it doesn't exist
...
-- Add RLS policies for event_courses
...
-- Add update trigger for event_courses
...
-- Allow public access to courses for published events
