...
async function runTests() {
  ...
  if (passed) {
    ...
    console.log('2. ✅ Uses upsert instead of delete/insert to preserve invitation status');
    console.log('3. ✅ Proper email service abstraction (currently logs to console)');
    console.log('4. ✅ Tracks which players need invitations vs those already invited');
    console.log('\n🔧 To enable actual email sending:');
    console.log('Set EMAIL_PROVIDER=sendgrid or EMAIL_PROVIDER=resend in .env');
    console.log('Add corresponding API keys (SENDGRID_API_KEY or RESEND_API_KEY)');
  }
}
