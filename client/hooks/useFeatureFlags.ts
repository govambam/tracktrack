import {
  useFeatureFlag,
  useFeatureEnabled,
} from "@/contexts/GrowthBookContext";
...
export const useWelcomeMessage = () =>
  useFeatureFlag("welcome-message", "Welcome to GolfOS!");
export const useDarkModeEnabled = () => useFeatureEnabled("enable-dark-mode");
export const useAdvancedFeaturesEnabled = () =>
  useFeatureEnabled("show-advanced-features");
...
export const useAIQuickstartFlow = () =>
  useFeatureEnabled("ai_quickstart_create_flow");
