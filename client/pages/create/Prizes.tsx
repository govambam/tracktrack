    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="border-green-100">
        ...
        <CardContent className="space-y-6">
          ...
          {enableContests && skillsContestsFromCourses.length > 0 && (
            <Card className="border-slate-100 bg-slate-50">
              <CardHeader>
                ...
                <CardDescription className="text-slate-600">
                  Official rules for hole contests and prize determination
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                    ...
                    <Card className="bg-white border-2 border-green-200">
                      <CardContent className="p-6">
                        <div className="flex items-center space-x-3 mb-4">
                          ...
                          <div>
                            <h3 className="text-lg font-bold text-green-900">Closest to the Pin</h3>
                            <p className="text-sm text-green-600">
                              ${contestPrizes.closestToPin || '0'} per hole
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-3">
                          <div className="bg-green-50 rounded-lg p-3">
                            <h4 className="font-semibold text-green-900 text-sm mb-2">Rules</h4>
                    ...
                    <Card className="bg-white border-2 border-orange-200">
                      <CardContent className="p-6">
                        <div className="flex items-center space-x-3 mb-4">
                          ...
                          <div>
                            <h3 className="text-lg font-bold text-orange-900">Long Drive</h3>
                            <p className="text-sm text-orange-600">
                              ${contestPrizes.longestDrive || '0'} per hole
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-3">
                          <div className="bg-orange-50 rounded-lg p-3">
                            <h4 className="font-semibold text-orange-900 text-sm mb-2">Rules</h4>
                          ...
                          <div className="bg-orange-50 rounded-lg p-3">
                            <h4 className="font-semibold text-orange-900 text-sm mb-2">Strategy Tips</h4>
                            <ul className="text-sm text-orange-700 space-y-1">
                ...
                <Alert className="border-slate-200 bg-white">
                  ...
                  <AlertDescription className="text-slate-700">
                    <div className="space-y-2">
                      <div className="font-medium">Contest Administration</div>
