            ...
            <Card className="border-green-100 bg-green-50">
              <CardContent className="p-4">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="font-medium text-green-900">Rules</h3>
                </div>
                <p className="text-sm text-green-700">
            ...
            <Card className="border-green-100 bg-green-50">
              <CardContent className="p-4">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="font-medium text-green-900">Leaderboard</h3>
                </div>
                <p className="text-sm text-green-700">
            ...
            <Card className="border-green-100 bg-green-50">
              <CardContent className="p-4">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="font-medium text-green-900">Travel</h3>
                </div>
                <p className="text-sm text-green-700">
