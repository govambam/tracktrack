  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const { error: roundsError } = await supabase
        .from('event_rounds')
        .update({ 
          scoring_type: scoringFormat === 'modified-stableford' ? 'stableford' : 'stroke_play',
          updated_at: new Date().toISOString()
        })
        .eq('event_id', eventId);
        ...
        <CardContent className="space-y-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <Label 
                  ...
                  className={cn(
                    ...
                    scoringFormat === 'stroke-play' && "text-emerald-700 font-medium"
                  )}
                >
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <Label 
                  ...
                  className={cn(
                    "flex-1 cursor-pointer",
                    scoringFormat === 'modified-stableford' && "text-emerald-700 font-medium"
                  )}
                >
                  <div className="flex items-center">
              ...
              <Card className={cn(
                ...
                <CardContent className="p-4">
                  <p className="text-sm text-green-700 mb-3">
                    Earn points based on performance relative to par. Highest points win.
                  </p>
                  <div className="grid grid-cols-2 gap-3 text-xs">
                    <div className="space-y-1">
                      <div className="text-green-800 font-medium">Points System:</div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="text-green-600">Double Bogey: -2 points</div>
          ...
          <Alert className="border-blue-200 bg-blue-50">
            ...
            <AlertDescription className="text-blue-700">
              <strong>Note:</strong> Changing the scoring format will apply to all rounds in this event. 
              This setting affects how leaderboards and final results are calculated.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
