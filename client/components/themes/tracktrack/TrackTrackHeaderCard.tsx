...
export const TrackTrackHeaderCard: React.FC<TrackTrackHeaderCardProps> = ({
  ...
  return (
    <div
      className={`inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-purple-100 to-pink-100 border border-purple-200 backdrop-blur-sm ${className}`}
    >
