    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Choose how you'd like to create your golf event. You can use AI to quickly generate everything or enter details manually.
          </DialogDescription>
        </DialogHeader>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          {/* Quick Start with AI */}
          <Card className="border-2 border-emerald-200 hover:border-emerald-300 transition-colors cursor-pointer" onClick={onQuickStart}>
            ...
            <CardContent className="text-center">
              <CardDescription className="text-slate-600 mb-4">
                Answer a few quick questions and let AI generate your event details, descriptions, and itinerary automatically.
              </CardDescription>
          ...
          {/* Manual Entry */}
          <Card className="border-2 border-slate-200 hover:border-slate-300 transition-colors cursor-pointer" onClick={onManualCreate}>
            <CardHeader className="text-center pb-4">
            ...
            <CardContent className="text-center">
              <CardDescription className="text-slate-600 mb-4">
                Have full control over every detail of your event. Perfect for complex events or specific requirements.
              </CardDescription>
              <div className="space-y-2 text-sm text-slate-500">
                <div className="flex items-center justify-center space-x-2">
